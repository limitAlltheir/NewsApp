...
import com.limitalltheir.newsapp.common.NewsApplication
...
class NewsViewModel(
    ...
    val breakingNews: MutableLiveData<Resource<NewsDto>> = MutableLiveData()
    var breakingNewsResponse: NewsDto? = null
    var breakingNewsPage = 1

    val searchNews: MutableLiveData<Resource<NewsDto>> = MutableLiveData()
    var searchNewsResponse: NewsDto? = null
    ...
    private fun handleBreakingNewsResponse(response: Response<NewsDto>): Resource<NewsDto> {
    ...
    private fun handleSearchNewsResponse(response: Response<NewsDto>): Resource<NewsDto> {
